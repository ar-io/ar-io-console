        ...
        async function fetchArNSProfile() {
            ...
            try {
                ...
                if (result && result.name) {
                    ...
                    try {
                        console.log(
                            "Fetching logo for ArNS name:",
                            primaryName,
                        );

                        // Create timeout for logo fetch with much longer timeout
                        const logoTimeoutPromise = new Promise<null>(
                            (resolve) => {
                                setTimeout(() => {
                                    console.log(
                        ...
                        const logoPromise = (async () => {
                            try {
                                ...
                                console.log(
                                    "No processId found in ArNS record",
                                );
                                return null;
                            } catch (innerError) {
                                console.log(
                                    "Inner logo fetch error:",
                                    innerError,
                                );
                                return null;
                            }
                ...
                console.log(
                    "No ArNS primary name found for address:",
                    address,
                    error,
                );
                setArnsName(null);
