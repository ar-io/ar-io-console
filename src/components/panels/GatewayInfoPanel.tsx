...
export default function GatewayInfoPanel() {
    ...
    const handleModeChange = (
        mode: "production" | "development" | "custom",
    ) => {
        setConfigMode(mode);
        ...
        <div className="px-4 sm:px-6">
            ...
            <div className="flex items-start gap-3 mb-4 sm:mb-6">
                ...
                <button
                    ...
                    title={
                        refreshing ? "Refreshing..." : "Refresh service data"
                    }
                >
                    <RefreshCw
                    ...
                    <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-border/20 pt-4">
                                            ...
                                            <PopoverPanel className="absolute right-0 z-10 mt-2 w-72 rounded-2xl bg-card border border-border/20 shadow-lg p-3">
                                                <div className="text-xs">
                                                    ...
                                                    <p className="text-foreground/80 leading-relaxed">
                                                        Enable for bundlers that
                                                        only support x402
                                                        payments (BASE-USDC
                                                        microtransactions).
                                                        Disables all payment
                                                        service features:
                                                        credits, fiat top-ups,
                                                        gifts, and balance
                                                        checking. Only crypto
                                                        payments via x402 will
                                                        be available.
                                                    </p>
                                                </div>
                                            </PopoverPanel>
                            ...
                            <div className="space-y-4 p-4 bg-background/50 rounded-2xl">
                                ...
                                <details>
                                    <summary className="cursor-pointer text-sm font-medium text-foreground/80 mb-3 hover:text-foreground">
                                        ...
                                        {
                                            Object.keys(currentConfig.tokenMap)
                                                .length
                                        }{" "}
                                        networks)
                                    </summary>
                        ...
                        {configMode !== "production" && (
                            <p className="text-sm text-warning mb-4 sm:mb-6">
                                Non-production endpoint services may not work as
                                expected
                            </p>
                        )}
                            ...
                            <div className="mb-4">
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="bg-card rounded-2xl p-4">
                                        ...
                                        <div className="text-lg font-bold text-foreground">
                                            {arIOGatewayInfo.weights.compositeWeight.toFixed(
                                                2,
                                            )}
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="bg-card rounded-2xl p-4">
                                        ...
                                        <div className="text-lg font-bold text-foreground">
                                            v{arweaveNodeInfo.version}.
                                            {arweaveNodeInfo.release}
                                        </div>
                                        <div className="text-xs text-foreground/80 mt-1">
                    ...
                    {gatewayInfo?.wallet && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-foreground/80">
                                    See more network configurations for this
                                    gateway.
                                </p>
                            </div>
                        </a>
