          ...
          <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-border/20 pt-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <span
                        className={`inline-block h-3 w-3 transform rounded-full bg-foreground transition-transform ${x402OnlyMode ? 'translate-x-5' : 'translate-x-1'}`}
                      />
                    </button>
                      ...
                      <PopoverPanel className="absolute right-0 z-10 mt-2 w-72 rounded-2xl bg-card border border-border/20 shadow-lg p-3">
                        <div className="text-xs">
                          ...
                          <p className="text-foreground/80 leading-relaxed">
                            Enable for bundlers that only support x402 payments (BASE-USDC
                            microtransactions). Disables all payment service features: credits, fiat
                            top-ups, gifts, and balance checking. Only crypto payments via x402 will
                            be available.
                          </p>
                        </div>
                      </PopoverPanel>
            ...
            <details className="mb-4 sm:mb-6">
              ...
              <div className="space-y-4 p-4 bg-background/50 rounded-2xl">
                ...
                <details>
                  <summary className="cursor-pointer text-sm font-medium text-foreground/80 mb-3 hover:text-foreground">
                    Token Gateway Configuration ({Object.keys(currentConfig.tokenMap).length}{' '}
                    networks)
                  </summary>
