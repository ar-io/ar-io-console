      ...
      <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl border border-primary/30 p-4 sm:p-6 mb-4 sm:mb-6">
        ...
        <div className="mb-6">
          ...
          {availability !== null && nameSearch && (
            <div
              className={`mt-4 p-4 rounded-2xl border text-center ${availability ? 'bg-card border-primary/30' : 'bg-error/10 border-error/20'}`}
            >
              {availability ? (
                <>
          ...
          <div className="mb-4 p-3 rounded-2xl bg-error/5 border border-error/10">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs text-error">
                ArNS domains require an Arweave or Ethereum wallet. You can search names but need to
                switch wallets to register.
              </p>
            </div>
          </div>
        )}
      ...
      <div className="bg-card rounded-2xl p-6 border border-border/20">
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-foreground/80 mb-4">
              For the complete ArNS experience including domain registration, management, and
              advanced features, visit the full ArNS application.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href="https://arns.ar.io"
