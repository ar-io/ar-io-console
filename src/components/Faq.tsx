    ...
    <div className="mt-8">
      ...
      <div className="space-y-3">
        {faqData.map((item, index) => (
          <div key={index} className="border border-border/20 rounded-2xl overflow-hidden">
            <button
            ...
            >
              ...
              <ChevronDown
                className={`w-5 h-5 text-foreground/80 transition-transform ${expandedIndex === index ? 'rotate-180' : ''}`}
              />
            </button>
            {expandedIndex === index && (
