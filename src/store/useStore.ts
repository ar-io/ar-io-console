...
import type {
    ...
    RoutingStrategy,
    VerificationMethod,
} from "../features/browse/types/index";
...
export const useStore = create<StoreState>()(
    persist(
        (set, get) => ({
            ...
            clearDeployHistory: () =>
                set({ deployHistory: [], fileHashCache: {} }), // Also clear file hash cache
            ...
            setPaymentIntentResult: (result) =>
                set({ paymentIntentResult: result }),
            ...
            // Just-in-time payment actions
            setJitPaymentEnabled: (enabled) =>
                set({ jitPaymentEnabled: enabled }),
            ...
            setSmartDeployEnabled: (enabled) =>
                set({ smartDeployEnabled: enabled }),
            ...
            resetBrowseConfig: () =>
                set({ browseConfig: DEFAULT_BROWSE_CONFIG }),
        }),
        {
