    ...
    <BaseModal onClose={loading ? () => {} : onClose}>
      <div className="mx-auto w-full max-w-lg min-w-[90vw] p-5 sm:min-w-[460px]">
        ...
        <input
          ...
          disabled={loading}
          className="w-full rounded-xl border border-border/20 bg-card px-3 py-2.5 text-sm text-foreground transition-colors focus:border-primary/50 disabled:opacity-60"
        />
