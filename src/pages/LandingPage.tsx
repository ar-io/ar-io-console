  ...
  return (
    <div className="space-y-12 px-4 sm:px-0">
      ...
      <div className="relative flex w-full flex-col items-center rounded-2xl border border-border/20 bg-card px-8 sm:px-12 py-10 overflow-hidden">
        ...
        {showWalletModal && <WalletSelectionModal onClose={handleWalletModalClose} />}
      </div>
      ...
      <div className="mb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
            Ar.io handles the complexity so you don't have to. Fund instantly, upload seamlessly,
            and access your permanent data through a decentralized CDN.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="bg-card border border-border/20 rounded-2xl p-6 hover:border-primary/50 transition-colors group">
            ...
            <p className="text-sm text-foreground/80">
              Buy Credits instantly with a card or crypto like ETH, SOL, ARIO, Stablecoins (via
              x402), and more — ready to upload in seconds.
            </p>
          </div>
          ...
          <div className="bg-card border border-border/20 rounded-2xl p-6 hover:border-primary/50 transition-colors group">
            ...
            <p className="text-sm text-foreground/80">
              Use your favorite Arweave, Ethereum, or Solana wallet to cryptographically sign and
              upload data.
            </p>
          </div>
          ...
          <div className="bg-card border border-border/20 rounded-2xl p-6 hover:border-primary/50 transition-colors group">
            ...
            <p className="text-sm text-foreground/80">
              Your files are bundled and permanently stored on Arweave — timestamped, tamper-proof,
            ...
            <div className="w-64 border-r border-border/20 bg-card/30">
              <div className="py-2">
                {features.map((feature, index) => (
                  ...
                  >
                    <feature.icon
                      className={`w-5 h-5 ${selectedFeatureIndex === index ? getFeatureColor().text : 'text-foreground/80'}`}
                    />
                    ...
                    <Listbox.Options className="absolute z-50 mt-1 w-full bg-card border border-border/20 rounded-2xl shadow-lg py-1">
                      {features.map((feature) => (
                        <Listbox.Option
                          key={feature.name}
                          className={({ active }) =>
                            `relative cursor-pointer select-none py-2 px-4 ${active ? 'bg-card text-foreground' : 'text-foreground/80'}`
                          }
                          value={feature}
                        >
                          <span className="flex items-center gap-3">
      ...
      <section className="mb-12">
        <div className="text-center mb-10">
          ...
          <p className="text-foreground/80">
            Follow the path from first upload to running your own infrastructure. Click any step to
            explore.
          </p>
        </div>
              ...
              {[
                {
                  ...
                  desc: (
                    <>
                      <strong className="text-foreground">Upload</strong> your first file
                      permanently
                    </>
                  ),
                  href: 'https://docs.ar.io/build/upload/bundling-services/',
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      <strong className="text-foreground">Deploy</strong> a decentralized app
                    </>
                  ),
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      <strong className="text-foreground">Explore</strong> more patterns
                    </>
                  ),
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      <strong className="text-foreground">Resolve</strong> and fetch content
                    </>
                  ),
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      Get a friendly <strong className="text-foreground">domain name</strong>
                    </>
                  ),
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      Learn how <strong className="text-foreground">gateways</strong> work
                    </>
                  ),
                ...
                },
                {
                  ...
                  desc: (
                    <>
                      <strong className="text-foreground">Run</strong> your own infra
                    </>
                  ),
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-white border-2 border-primary/30 rounded-lg px-3 py-3 group-hover:border-primary/50 transition-colors">
                    <p className="text-xs text-foreground/80 mb-2">
                      <strong className="text-foreground">Learn</strong> the fundamentals of ar.io
                      and Arweave
                    </p>
      ...
      <section className="text-center bg-card rounded-2xl border border-border/20 p-4 sm:p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-foreground/80 mb-6">
            ArDrive is a user-friendly permanent dropbox app. Preserve and share your most important
            files with a simple drag-and-drop interface. Manage smart domain names, create permanent
            websites, and organize your files—all without writing code.
          </p>
          <a
